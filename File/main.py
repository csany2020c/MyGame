...
# Ez az osztály az adatfájl egyetlen sorának (egy rekordnak) a tárolásához készült. Ebből később annyi példány készül,
# ahány adatsor van a fájlban.
class Data:

    # A konstruktorán keresztül kap majd meg egy teljes adatsort, amelyet feldolgoz, és a benne lévő mezőkben
    # eltárol. A feldolgozás során a szöveges tartalmat a megfelelő formátumokba alakítja át.
    def __init__(self, parseString: str) -> None:
        super().__init__()
        print("Create Data from String")
        print(parseString) # A konstruktoron keresztül megkapott szöveg kiírása

        fields: List['str'] = parseString.split(" ") # A beérkező szöveget szóközöknél fogva felbondja, a visszaadott eredmény egy lista, amelynek annyi eleme lesz, ahány felé darabolta. Az első elem indexe 0.
        ...
        for i in range(5, len(fields)): # Az 5. elemtől a lista végéig számol, 1-esével, azaz a fennmaradó indexeket veszi elő, pládul 5 (Hello),6 (World)
