...
class Stage3(game.scene2d.MyStage):
    def __init__(self):
        ...
        self.a = MenuActor1()
        self.a.set_size(self.width * 0.1 * 3.1, self.height * 0.1)
        ...
        self.b = MenuActor2()
        self.b.set_size((self.width * 0.1) * 3.1, self.height * 0.1)
